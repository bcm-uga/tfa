...
The number of factors could be determined by PCA or other methods for analysis of population structure. Here it could be taken equal to the number of axes in the PCA. Since the `tfa` method is based low rank approximation of data matrices, lower values such `k = 2` work too.
